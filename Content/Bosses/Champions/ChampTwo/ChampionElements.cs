...
namespace FargowiltasEternalBoss.Content.Bosses.Champions.ChampTwo
{
    public class ChampionElements : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange([
                ...
                new FlavorTextBestiaryInfoElement("Mods.FargowiltasEternalBoss.Bestiary.ChampionElements")
            ]);
        }
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<AerospecEnchant>(), 5));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<DaedalusEnchant>(), 5));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<ReaverEnchant>(), 5));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<HydrothermicEnchant>(), 5));
        }
    }
}
